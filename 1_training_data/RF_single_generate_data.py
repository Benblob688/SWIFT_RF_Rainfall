'''
Code to generate an array for training a random forest for a single requested hour.

Usage:

RF_generate_data.py <YYYY> <MM> <DD> <hh>

inputs: date and hour only (<mm> is done inside this script)
